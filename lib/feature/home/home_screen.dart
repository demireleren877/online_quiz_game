        ...
        child: Column(
          ...
          children: [
              ...
              onPress: () {
                Hive.box(HiveConstants.boxName).isNotEmpty
                    ? Navigator.push(context,
                        MaterialPageRoute(builder: (_) => CreateRoom()))
            ...
            CustomButton(
              ...
              onPress: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (_) => GameList()));
              },
            ),
            SizedBox(height: 25.h),
            CustomButton(
              btnText: HomeConstants.btn3Text,
              onPress: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (_) => CreateRoom()));
              },
            ),
