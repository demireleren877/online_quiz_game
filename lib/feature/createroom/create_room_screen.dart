                ...
                itemBuilder: (context, index) {
                  return Observer(
                      builder: (c) => SelectableButton(
                          factor: 5,
                          collecter: 4,
                          selectKind: _createVM.selectedTimeIndex,
                          onTap: () {
                ...
                itemBuilder: (context, index) {
                  return Observer(
                      builder: (c) => SelectableButton(
                          factor: 5,
                          collecter: 1,
                          selectKind: _createVM.selectedQuestIndex,
                          onTap: () {
                            _createVM.selectedQuestIndex = index;
                          },
                          index: index));
                },
              ),
                ...
                itemBuilder: (context, index) {
                  return Observer(
                      builder: (c) => SelectableButton(
                          factor: 2,
                          collecter: 1,
                          selectKind: _createVM.selectedPlayerIndex,
                          onTap: () {
                            _createVM.selectedPlayerIndex = index;
                          },
                          index: index));
                },
              ),
